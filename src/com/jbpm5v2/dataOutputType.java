...
public class dataOutputType extends com.migration.xml.TypeBase
{
		public static com.migration.xml.meta.ComplexType getStaticInfo() { return new com.migration.xml.meta.ComplexType(com.jbpm5v2.jbpm5v2_TypeInfo.binder.getTypes()[com.jbpm5v2.jbpm5v2_TypeInfo._altova_ti_altova_dataOutputType]); }
	
	public dataOutputType(org.w3c.dom.Node init)
	{
		super(init);
		instantiateMembers();
	}
	...
	{
		name = new MemberAttribute_name (this, com.jbpm5v2.jbpm5v2_TypeInfo.binder.getMembers()[com.jbpm5v2.jbpm5v2_TypeInfo._altova_mi_altova_dataOutputType._name]);
		id = new MemberAttribute_id (this, com.jbpm5v2.jbpm5v2_TypeInfo.binder.getMembers()[com.jbpm5v2.jbpm5v2_TypeInfo._altova_mi_altova_dataOutputType._id]);
