...
import com.migration.AltovaException;
import com.migration.typeinfo.MemberInfo;
...
public class XmlTreeOperations
{
    ...
    public static String getTextContent(Node node)
    {
        ...
        {
            return com.migration.CoreTypes.castToString(node.getNodeValue());
        }
        else
    ...
    public static void setValue(Node node, MemberInfo member, com.migration.types.DateTime b)
    {
        setValue(node, member, getFormatter(member).format(b));
    }

    public static void setValue(Node node, MemberInfo member, com.migration.types.Duration b)
    {
        setValue(node, member, getFormatter(member).format(b));
    }
    ...
    {
        return com.migration.CoreTypes.castToDouble( getTextContent(node) );
    }

    public static String castToString(Node node, MemberInfo member)
    {
        return com.migration.CoreTypes.castToString( getTextContent(node) );
    }

    public static long castToLong(Node node, MemberInfo member)
    {
        return com.migration.CoreTypes.castToLong( getTextContent(node) );
    }

    public static int castToInt(Node node, MemberInfo member)
    {
        return com.migration.CoreTypes.castToInt( getTextContent(node) );
    }

    public static BigInteger castToBigInteger(Node node, MemberInfo member)
    {
        return com.migration.CoreTypes.castToBigInteger( getTextContent(node) );
    }

    public static BigDecimal castToBigDecimal(Node node, MemberInfo member)
    {
        return com.migration.CoreTypes.castToBigDecimal( getTextContent(node) );
    }

    public static boolean castToBool(Node node, MemberInfo member)
    {
        return com.migration.CoreTypes.castToBool( getTextContent(node) );
    }

    public static com.migration.types.DateTime castToDateTime(Node node, MemberInfo member)
    {
        return com.migration.CoreTypes.castToDateTime( getTextContent(node) );
    }

    public static com.migration.types.Duration castToDuration(Node node, MemberInfo member)
    {
        return com.migration.CoreTypes.castToDuration( getTextContent(node) );
    }
    ...
    public static javax.xml.namespace.QName castToQName(Node node, MemberInfo member)
    {
        ...
        int i = value.indexOf(':');
        if (i == -1)
            return com.migration.CoreTypes.castToQName(value);
    ...
    public static Document loadDocument(com.migration.io.Input input) throws Exception
    {
        if (input instanceof com.migration.io.FileInput)
        {
            return loadDocument(((com.migration.io.FileInput)input).getFilename());
        }
        switch (input.getType())
        {
            case com.migration.io.Input.IO_STREAM:
                return loadDocument(new org.xml.sax.InputSource(input.getStream()));
            
            case com.migration.io.Input.IO_READER:
                return loadDocument(new org.xml.sax.InputSource(input.getReader()));
            
            case com.migration.io.Input.IO_DOM:
    ...
    public static Document loadDocument(org.xml.sax.InputSource source ) throws Exception
    {
        ...
        {
            throw new com.migration.SourceInstanceUnavailableException("cannot parse input stream.", e);
        }
    }
    ...
    public static Document loadDocument( String filename ) throws Exception
    {
        ...
        {
            throw new com.migration.SourceInstanceUnavailableException("cannot parse input file.", e);
        }
    }
    ...
    public static Document loadXmlBinary( byte[] xmlTree ) throws Exception
    {
        ...
        {
            throw new com.migration.SourceInstanceUnavailableException("Cannot parse binary.", e);
        }
    }
    ...
    public static void saveDocument( Document doc, com.migration.io.Output output, String encoding, boolean bBigEndian, boolean bBOM, boolean prettyPrint ) throws Exception
    {
        switch (output.getType())
        {
        case com.migration.io.Output.IO_STREAM:
            saveDocument(doc, output.getStream(), encoding, bBigEndian, bBOM, prettyPrint);
            break;
            
        case com.migration.io.Output.IO_WRITER:
            saveXml(doc, prettyPrint, output.getWriter());
            break;
            
        case com.migration.io.Output.IO_DOM:
            break;
    ...
    public static void saveDocument( Document doc, java.io.OutputStream targetStream, String encoding, boolean bBigEndian, boolean bBOM, boolean prettyPrint ) throws Exception
    {
        ...
        {
            throw new com.migration.TargetInstanceUnavailableException("Cannot write to output stream", e);
        }
    }
    ...
    public static byte[] saveXmlBinary( Document doc, String encoding, boolean bBigEndian, boolean bBOM, boolean prettyPrint ) throws Exception
    {
        ...
        {
            throw new com.migration.TargetInstanceUnavailableException("Cannot serialize.", e);
        }
    }
