...
public class BPMNEdgeType extends com.migration.xml.TypeBase
{
		public static com.migration.xml.meta.ComplexType getStaticInfo() { return new com.migration.xml.meta.ComplexType(com.jbpm5processdoc.jbpm5processdoc_TypeInfo.binder.getTypes()[com.jbpm5processdoc.jbpm5processdoc_TypeInfo._altova_ti_altova_BPMNEdgeType]); }
	
	public BPMNEdgeType(org.w3c.dom.Node init)
	{
		super(init);
		instantiateMembers();
	}
	...
	{
		bpmnElement = new MemberAttribute_bpmnElement (this, com.jbpm5processdoc.jbpm5processdoc_TypeInfo.binder.getMembers()[com.jbpm5processdoc.jbpm5processdoc_TypeInfo._altova_mi_altova_BPMNEdgeType._bpmnElement]);

		waypoint= new MemberElement_waypoint (this, com.jbpm5processdoc.jbpm5processdoc_TypeInfo.binder.getMembers()[com.jbpm5processdoc.jbpm5processdoc_TypeInfo._altova_mi_altova_BPMNEdgeType._waypoint]);
	}
	// Attributes
